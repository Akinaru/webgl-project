# Modèles de la scène Recyclage

Cette scène utilise des modèles compressés avec **Draco** pour optimiser les performances de chargement.

## Convention de nommage
- Modèle source : `SceneRecyclage.gltf`
- Modèle optimisé : `SceneRecyclage_Draco.glb` (utilisé par le jeu)
...
```bash
node tools/compress-models.cjs public/models/scenes/recyclage/SceneRecyclage.gltf
```
