...
export const BLOOM_FACE_MESH_NAME_TOKEN = 'bloom-face'
export const BLOOM_BODY_MESH_NAME_TOKEN = 'bloom'
export const BLOOM_FACE_FRAME_COUNT = 5
export const BLOOM_FACE_ANIMATION_FRAME_MS = 150
export const BLOOM_MOVEMENT_FACING_MIN_STEP = 0.01
export const BLOOM_FACE_PLAYER_MIN_DISTANCE = 0.35
export const BLOOM_COLLISION_RAY_PADDING = 0.22
export const BLOOM_COLLISION_SAFE_DISTANCE = 0.24
